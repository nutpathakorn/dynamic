...
<div id="pre-loader">
    <img src="{{URL::asset('resources/assets/images/pre-loader/loader-01.svg')}}" alt="">
</div>
...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="text-left navbar-brand-wrapper">
    <a class="navbar-brand brand-logo" href="index.html"><img src="{{URL::asset('resources/assets/images/logo-dark.png')}}" alt="" ></a>
    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{URL::asset('resources/assets/images/logo-icon-dark.png')}}" alt=""></a>
  </div>
  <!-- Top bar left -->
  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mr-30">
      <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        <img src="{{URL::asset('resources/assets/images/profile-avatar.jpg')}}" alt="avatar">
      </a>
    ...
    <div class="side-menu-fixed">
     <div class="scrollbar side-menu-bg">
      <ul class="nav navbar-nav side-menu" id="sidebarnav">
        <!-- menu item Dashboard-->
         <li>
          <a href="{{URL::to('/')}}"><i class="ti-home"></i><span class="right-nav-text">Dashboard</span> </a>
        </li>
        <li>
          <a href="{{URL::to('/')}}"><i class="ti-menu-alt"></i><span class="right-nav-text">Lists</span> </a>
        </li>
        <li>
          <a href="{{URL::to('/')}}"><i class="ti-calendar"></i><span class="right-nav-text">Schedules</span> </a>
        </li>
        <li>
          <a href="{{URL::to('register')}}"><i class="ti-clipboard"></i><span class="right-nav-text">Register</span> </a>
        </li>
