...
$(document).ready(function() {
	...
	document.getElementById("txtstaff").value
							+"&staff_addr="+document.getElementById("txtaddress").value
							+"&staff_rd="+document.getElementById("txtroad").value
							+"&staff_dist="+document.getElementById("txtdistrict").value
							+"&staff_prov="+document.getElementById("txtprovince").value
							+"&staff_subd="+document.getElementById("txtsubdistrict").value
							+"&staff_post="+document.getElementById("txtpost").value
							+"&staff_phon="+document.getElementById("txtphone").value
							+"&staff_mobi="+document.getElementById("txtmobile").value
							+"&staff_mail="+document.getElementById("txtmails").value;

		// Initialize
		$('.noty-runner').click(function () {
		if(document.getElementById("txtstaff").value ===  ""){
			noty({
				force: true,
...
<script> 
    function create_staff_submit()
    {
		var notes = [];
		var selectElement = document.getElementById("txtposition");
		var selectedOptionText = selectElement.options[selectElement.selectedIndex].text;
		var randomNumber = "ST"+generateNumber();
		var dataString = "staff_id="+randomNumber
							+"&staff_name="+document.getElementById("txtstaff").value
							+"&staff_dept_id="+selectElement.value
							+"&staff_dept_name="+selectedOptionText
							+"&staff_addr="+document.getElementById("txtaddress").value
							+"&staff_rd="+document.getElementById("txtroad").value
							+"&staff_dist="+document.getElementById("txtdistrict").value
							+"&staff_prov="+document.getElementById("txtprovince").value
...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">สร้างพนักงาน</span></h4>
		</div>
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			...
			<li><a href="form_layout_vertical.html">สร้างพนักงาน</a></li>
		</ul>
	...
	<form>
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">สร้างพนักงาน</h5>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6">
						<fieldset>
							...
							<div class="form-group">
								<label>ชื่อพนักงาน: <span class="text-danger text-size-small">*</span></label>
								<input type="text" id="txtstaff" name="txtstaff" class="form-control" placeholder="ชื่อพนักงาน">
							</div>

							<div class="form-group">
								<label>ตำแหน่ง: <span class="text-danger text-size-small">*</span></label>
								<select data-placeholder="ตำแหน่ง" class="select" id="txtposition" name="txtposition">
									<option></option>
									<option value=1>พนักงานส่งของ</option>
									<option value=2>แอดมิน</option>
									<option value=3>แอดมินระบบ</option>
								</select>
							</div>
					...
					<div class="col-md-6">
						<fieldset>
							<legend class="text-semibold"><i class="icon-office position-left"></i> ที่อยู่พนักงาน</legend>
