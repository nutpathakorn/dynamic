...
$(document).ready(function() {
  	...
  	textBox.disabled = true;
		...
		$('#selectCustUser').DataTable({
				...
				"columns": [
					...
					{ "data": "company_addr1_name" },
					{ "data": "company_addr1_condition" },
					{ "data": "company_addr2_name" },
					{ "data": "company_addr2_condition" },
					{ 
						"data": "company_user_cid",
						"render": function ( data, type, row ) {
							return '<button type="button" class="btn btn-primary btn-icon text-center addSelected" data-toggle="modal" data-target="#modal_full" data-cusid="' + data + '"><i class="icon-pencil5"></i></button><button type="button" class="btn btn-danger btn-icon text-center ml-10 deleteSelected" data-deletecusid="' + data + '"><i class="icon-bin"></i></button>';
						}
					}
				]
			});
	...
	$('#selectCustUser').on('click', '.addSelected', function() {
	...
	$('#selectCustUser').on('click', '.deleteSelected', function() {

	var deletecusid = $(this).data('deletecusid');
	console.log(deletecusid);
	getCusIdDelete(deletecusid);
